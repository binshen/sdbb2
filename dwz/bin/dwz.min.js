			...
			function tdHtml(field){
				...
				switch(field.type){
					...
					case 'date':
						...
						break;
					case 'file':
						html = '<input type="file" name="'+field.name+'" value="'+field.defaultVal+'" class="'+field.fieldClass+'" size="'+field.size+'"/>';
						break;
					case 'file_class':
						html = '<input type="text"  class="txt" readonly/><input type="button" class="btn" value="浏览..." onclick="fileBtnClick(this);"/><input type="file" name="'+field.name+'" class="file" id="fileField"  onchange="change_pic(this);" />';
						break;
					default:
